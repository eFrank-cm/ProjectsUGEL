                    ...
                    <style>
                        ...
                        .page-link:hover{
                            color: black;
                                    ...
                                    <tbody>  
                                    <!-- Datos Lenguas -->
                                    <?php  $query ="SELECT * FROM `user_form`"; $resultado = $conn->query($query); ?>
                                    <?php while($row = $resultado -> fetch_array())
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class ='text-center'> <button type="button" class="btn btn-outline-warning bi bi-pencil editbtn"></button> <button type="button" class="btn btn-outline-danger bi bi-key resetpass-btn"> </button>  
                                            </td>
                                            </tr>
                                        <?php    
                                    }
